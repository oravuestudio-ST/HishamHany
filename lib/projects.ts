...
const raw: Omit<Project, 'slug'>[] = [
  ...
  { id: 8, title: 'Ayman & Salma — Party', category: 'Editorial', year: '2024', client: 'Ayman & Salma', image: '/images/Childs/PARTY/AymanSalma_party-001.JPG', aspect: 'landscape' },
  ...
  { id: 12, title: 'Glitch Set', category: 'Fashion', year: '2024', client: 'Glitch Goods', image: '/images/Fashion/GLITCH%20GOODS/Gitch%20set/Glitch_set-001.jpg', aspect: 'portrait' },
  ...
  { id: 9, title: 'Koptan — Jetta', category: 'Automotive', year: '2024', client: 'Koptan', image: '/images/Automotive/koptan%20jetta/Koptan_jetta-001.JPG', aspect: 'landscape' },
  { id: 5, title: 'Seat Ibiza', category: 'Automotive', year: '2024', client: 'Automotive Campaign', image: '/images/Automotive/Auto_ibiza-001.JPG', aspect: 'landscape' },
